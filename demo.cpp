...
#include <numeric>
#define ll long long
#define VANSHU2308 ios_base::sync_with_stdio(0);  cin.tie(0); cout.tie(0); 
...
int main(){
    ifstream vocab_file("./vocab.txt"), trans_file("./trans.txt");
    string str;

    cout << endl;


    while(getline(vocab_file, str)){ vocab.push_back(str); }
